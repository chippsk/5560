...
public class weather {
    ...
    public weather() {
        ...
        webTarget = client.target(BASE_URI).path("getForecastRSS.aspx");
    }
     ...
     */
    public <T> T getForecastRSS(Class<T> responseType, String aCode, String... optionalQueryParams) throws ClientErrorException {
